% report.tex - Boilerplate LaTeX report for Decentralized Inheritance Protocol
...
% Title page info
\title{Decentralized Inheritance Protocol\\Report}
\author{Noah Klaholz \\ and contributors}
\date{\today}

% Appendix settings
\usepackage[toc,page]{appendix}

% For nicer section headings
\usepackage{sectsty}
...
\begin{titlepage}
  \centering
  {\scshape\LARGE Decentralized Inheritance Protocol \par}
  \vspace{1.5cm}
  {\huge\bfseries Report\par}
  \vspace{2cm}
  {\Large Noah Klaholz \\ Department / Organization \par}
  \vfill
